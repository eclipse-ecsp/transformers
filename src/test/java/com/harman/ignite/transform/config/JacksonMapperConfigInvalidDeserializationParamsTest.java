...
public class JacksonMapperConfigInvalidDeserializationParamsTest {
    ...
    public static Collection<?> customDeserializerList() {
        return Arrays.asList(new Object[] { "com.harman.ignite.transform.config.ItemToUserNameMapping:",
                                            ":com.harman.ignite.transform.config.ItemToUserNameDeserializer", 
                                            "com.harman.ignite.transform.config.ItemToUserNameMapping:"
                                            + "com.harman.ignite.transform.config.ItemToUserNameMappingSerializer" });
    }
